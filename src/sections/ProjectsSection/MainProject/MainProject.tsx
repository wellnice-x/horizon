        ...
        >
          ...
          <div className={styles.buttonGroup}>
            ...
            <Button
              className={styles.button}
              as="a"
              href="https://github.com/wellnice-x/todoshka-app-fsd"
              target="_blank"
              rel="noopener noreferrer"
            >
              FSD версия - GitHub
        ...
        >
          <div className={styles.baseInfoContainer}>
            ...
            <p className={styles.briefDescription}>
              ...
              клиентских, сетевых и серверных ошибок. Интерфейс, в свою очередь,
              всегда стремится отображать актуальное состояние данных.
              <br />
              Приложение спроектировано с учётом масштабируемости и реальных
              сценариев использования.
              <br />
              На данный момент используется упрощенная анонимная аутентификация
              пользователя.
              <br />
              Текущая архитектурная база позволяет адаптировать проект под
              множество других веб-приложений.
              <br />
              Отдельно была создана версия с выполненной миграцией на
              методологию Feature-Sliced Design (FSD). В этой версии, помимо
              самого переноса, была улучшена декомпозиция больших хуков и
              компонентов.
            </p>
          </div>
